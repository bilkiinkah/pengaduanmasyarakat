    ...
    <div class="card-body">
      ...
      <form action="{{ route('register.store') }}" method="POST">
        ...
        <div class="input-group mb-3">
          <input type="text" name="nama" value="{{ old('nama') }}" required autocomplete="nama" autofocus  class="form-control @error('nama') is-invalid @enderror" placeholder="nama">
        ...
        <div class="input-group mb-3">
          <input type="text" name="tlp" value="{{ old('tlp') }}" required autocomplete="name" autofocus class="form-control @error('name') is-invalid
